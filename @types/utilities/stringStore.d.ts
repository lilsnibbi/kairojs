import type { Pointer } from "@/utilities/stringStore/lib/shared/pointer.ts";
...
> = EntryName extends keyof Entries
	? never
	: import("@/utilities/stringStore/lib/schema/schema.ts").Schema<
			Id,
			{
...
export type KeyOfSchema<SchemaValue extends object> =
	SchemaValue extends import("@/utilities/stringStore/lib/schema/schema.ts").Schema<
...
> = Id extends keyof Entries
	? never
	: import("@/utilities/stringStore/lib/schema/schemaStore.ts").SchemaStore<{
...
export type KeyOfStore<SchemaStoreValue extends object> =
	SchemaStoreValue extends import("@/utilities/stringStore/lib/schema/schemaStore.ts").SchemaStore<
