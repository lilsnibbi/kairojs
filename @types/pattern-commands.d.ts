...
import type { PatternCommandEvents as PatternCommandEventsConstant } from "@/constants/pattern-commands.ts";
import type { UserError } from "@/errors/user-error.ts";
import type { PatternCommand } from "@/structures/pattern-command.ts";
