...
import { EmbedLimits } from "@utilities/discord/index.ts";
import { isFunction, isNullishOrEmpty } from "@utilities/common/index.ts";
import {
	EmbedBuilder,
	isJSONEncodable,
	type APIEmbed,
 ...
 * @example
 * ```typescript
 * import { PaginatedMessageEmbedFields } from "kairojs/utilities/discordjs";
 *
