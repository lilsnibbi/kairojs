...
import { MessagePrompterBaseStrategy } from "./strategies/message-prompter-base-strategy.ts";
import { MessagePrompterConfirmStrategy } from "./strategies/message-prompter-confirm-strategy.ts";
import { MessagePrompterMessageStrategy } from "./strategies/message-prompter-message-strategy.ts";
import { MessagePrompterNumberStrategy } from "./strategies/message-prompter-number-strategy.ts";
import { MessagePrompterReactionStrategy } from "./strategies/message-prompter-reaction-strategy.ts";
 ...
 * @example
 * ```typescript
 * import { MessagePrompter } from "kairojs/utilities/discord.js-utilities";
 *
