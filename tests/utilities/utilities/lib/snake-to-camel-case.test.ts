...
import { snakeToCamelCase } from "@utilities/utilities/index.ts";
...
describe("snakeToCamelCase", () => {
	...
	test("should correctly handle strings with multiple underscores", () => {
		expect(snakeToCamelCase("multiple__underscores")).toBe(
	...
	test("should correctly handle strings with mixed hyphens and underscores", () => {
		expect(snakeToCamelCase("mixed_case-and-hyphens")).toBe(
			"mixedCaseAndHyphens",
		);
	});
