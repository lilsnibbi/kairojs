...
} from "@utilities/string-store/index.ts";
...
describe("types", () => {
	...
	describe("Int32", () => {
		...
		test.each([-2_147_483_648, -52100, 420, 2_147_483_647])(
			"GIVEN a buffer THEN it serializes and deserializes correctly",
			(value) => {
				const buffer = new UnalignedUint16Array(10);
	...
	describe("Uint64", () => {
		...
		test.each([0, 640_000_420, 9_007_199_254_740_991])(
			"GIVEN a buffer THEN it serializes and deserializes correctly",
			(value) => {
				const buffer = new UnalignedUint16Array(10);
	...
	describe("BigInt32", () => {
		...
		test.each([-2_147_483_648n, -52100n, 420n, 2_147_483_647n])(
			"GIVEN a buffer THEN it serializes and deserializes correctly",
			(value) => {
				const buffer = new UnalignedUint16Array(10);
	...
	describe("BigUint32", () => {
		...
		test.each([0n, 420n, 4_294_967_295n])(
			"GIVEN a buffer THEN it serializes and deserializes correctly",
			(value) => {
				const buffer = new UnalignedUint16Array(10);
	...
	describe("BigUint64", () => {
		...
		test.each([0n, 18_446_744_073_709_551_615n])(
			"GIVEN a buffer THEN it serializes and deserializes correctly",
			(value) => {
				const buffer = new UnalignedUint16Array(10);
	...
	describe("Nullable", () => {
		...
		test.each([null, undefined])(
			"GIVEN a null value THEN it serializes and deserializes correctly",
			(input) => {
	...
	describe("Array(Bit)", () => {
		...
		// Each row is wrapped in a single-element tuple: `test.each` spreads array rows across the
		// callback's parameters, which would otherwise mangle any value that is itself an array.
		test.each([
			["Foo"],
			[() => {}],
			[true],
			...
			[{ length: "0" }],
			[{ length: 1 }],
		])("GIVEN an invalid value THEN it throws an error", (value) => {
			const buffer = new UnalignedUint16Array(10);
	...
	describe("FixedLengthArray(Bit)", () => {
		...
		// Each row is wrapped in a single-element tuple: `test.each` spreads array rows across the
		// callback's parameters, which would otherwise mangle the two array cases below.
		test.each([
			["Foo"],
			[() => {}],
			[true],
	...
	describe("Snowflake", () => {
		...
		test.each([737141877803057244n, "737141877803057244"])(
			"GIVEN a buffer THEN it serializes and deserializes correctly",
			(value) => {
				const buffer = new UnalignedUint16Array(10);
