...
import { Cron } from "@utilities/cron/index.ts";
...
describe("Cron", () => {
	...
	test("any instant", () => {
		...
		const [minutes, hours, date, month, day] = specimen.normalized
			.split(" ")
			.map(Number);
